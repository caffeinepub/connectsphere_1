...
import { SAMPLE_POSTS, generateAvatarUrl } from "../lib/mockData";
    ...
    <div className="flex flex-col">
      ...
      <div className="px-4 pb-4">
        ...
        <div className="grid grid-cols-3 gap-2 mb-4">
          {[
            ...
            <div
              key={label}
              className="flex flex-col items-center py-3 px-2 rounded-2xl bg-muted/60 border border-border/50"
            >
      ...
      <div className="border-t border-border/50">
        ...
        <div className="flex border-b border-border/50">
          <button
            type="button"
            className="flex-1 flex items-center justify-center gap-2 py-3 text-sm font-semibold text-primary border-b-2 border-primary"
          >
          ...
          <button
            type="button"
            className="flex-1 flex items-center justify-center gap-2 py-3 text-sm font-semibold text-muted-foreground hover:text-foreground transition-colors"
          >
                ...
                >
                  {post.imageUrl ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center p-3 bg-gradient-to-br from-primary/10 to-primary/5">
                      <p className="text-xs text-foreground text-center line-clamp-5 leading-tight">
                        {post.content}
                      </p>
                    </div>
                  )}
