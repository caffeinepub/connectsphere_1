    ...
    switch (nav.page) {
      ...
      case "chat-thread":
        return (
          <ChatThreadPage
            navigate={navigate}
            conversationId={nav.params?.conversationId || "1"}
          />
        );
      case "profile":
      ...
      case "edit-profile":
        return (
          <EditProfilePage navigate={navigate} userProfile={userProfile} />
        );
      case "notifications":
