...
import { Loader2, ArrowRight, Zap, Users, Bell, Moon } from 'lucide-react';
...
const FEATURES = [
  ...
  { icon: Moon, label: 'Beautiful dark & light themes', color: 'text-purple-400' },
];
            ...
            <div className="mb-6 flex items-center gap-3">
              ...
              <div>
                <h1 className="font-display font-extrabold text-3xl text-white leading-none">
                  Connect<span className="gradient-text" style={{ WebkitTextFillColor: 'transparent', background: 'linear-gradient(90deg, #a78bfa, #60a5fa)', WebkitBackgroundClip: 'text' }}>Sphere</span>
                </h1>
          ...
          <div className="max-w-sm mx-auto w-full animate-slide-up">
            ...
            <div className="mb-8 space-y-3">
              ...
              {FEATURES.map(({ icon: Icon, label, color }) => (
                <div key={label} className="flex items-center gap-3 p-3 rounded-2xl bg-muted/50 border border-border/50">
