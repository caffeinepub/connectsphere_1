...
const BACK_PAGES: AppPage[] = ['edit-profile', 'post-detail', 'chat-thread', 'create-post', 'create-story', 'story-viewer', 'notifications'];
      ...
      <header className="sticky top-0 z-40 bg-background/80 glass border-b border-border">
        <div className="flex items-center justify-between px-4 h-14">
          <div className="flex items-center gap-2">
            ...
            />
            <span className="font-display font-bold text-lg gradient-text">ConnectSphere</span>
          </div>
          <div className="flex items-center gap-2">
            <ThemeToggle />
            <button
