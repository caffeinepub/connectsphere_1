...
export function generateAvatarUrl(seed: string): string {
  ...
  const color = colors[Math.abs(seed.charCodeAt(0) + seed.charCodeAt(seed.length - 1)) % colors.length];
...
export const SAMPLE_POSTS: Post[] = [
  {
    ...
    content: 'Just launched my new project! 🚀 So excited to share this with the world. ConnectSphere is the future of social networking.',
  ...
  },
  {
    ...
    content: 'Beautiful sunset from my balcony tonight 🌅 Sometimes you just need to pause and appreciate the little things.',
  ...
  },
  {
    ...
    content: 'Working on some exciting new designs today. The creative process never gets old! 🎨 #design #creativity',
  ...
  },
  {
    ...
    content: 'Coffee + code = perfect morning ☕💻 Building something amazing today. Stay tuned!',
